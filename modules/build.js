...
const build = props => {
    ...
    let entry = getEntry(isArray(props.src) ? props.src.map(p => path.resolve(props.root, p)) : path.resolve(props.root, props.src));
    ...
    let forProductionPlugins =
        process.env.NODE_ENV === 'production'
            ? Object.assign(
                  ...
                  props.styles
                      ? {
                            ExtractTextPlugin: Object.assign(
                                {},
                                { styles: props.styles },
                                props.build_version ? { build_version: props.build_version } : {}
                            )
                        }
                      : {}
              )
